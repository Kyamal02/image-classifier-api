...
@patch('api.main.preprocess_image')  # Добавляем мокирование для preprocess_image
def test_classify_endpoint(mock_preprocess, mock_load_model):
    ...
    # Мокируем функцию format_predictions
    ...
    # Проверка с невалидным расширением
    response = client.post(
        "/classify/",
